...
export default function SignUp() {
  ...
  return (
    <div className="flex flex-col items-center justify-between h-screen px-4 py-10">
      <div></div>
      ...
      <div className="w-full max-w-sm flex flex-col gap-4">
        <Button className="w-full h-12 font-semibold text-base shadow-lg shadow-primary/20 rounded-full" onClick={signUp}>
