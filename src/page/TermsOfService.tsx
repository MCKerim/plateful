      ...
      <div className="space-y-6 pb-8">
        ...
        <div className="space-y-6 text-sm">
          <section className="space-y-3">
            ...
            <p>
              By downloading, accessing, or using the Plateful mobile
          ...
          <section className="space-y-3">
            ...
            <p>
              Plateful is a recipe and meal planning application that allows
              users to:
            </p>
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>
                  We are not liable for any loss or damage from unauthorized
                  account access
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p>
                You retain ownership of the recipes, photos, and other content
                you create and upload to Plateful. However, by using our App,
                you grant us a non-exclusive, worldwide, royalty-free license to
                use, store, and display your content as necessary to provide the
                service.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                Terms or our community standards, with or without notice.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              The Plateful App, including its design, functionality, and
              original content, is protected by copyright, trademark, and other
              intellectual property laws. You may not copy, modify, distribute,
              or create derivative works of our App without explicit permission.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p>
                Plateful provides recipes and meal planning tools for
                informational purposes only. We are not responsible for food
                safety, dietary restrictions, allergies, or health consequences
                resulting from recipes or meal plans. Always verify ingredient
                safety and consult healthcare professionals for dietary advice.
              </p>
            </div>
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                or contacting our support team. Upon termination, your access to
                the App will cease, and your data may be deleted according to
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              laws of the jurisdiction where Plateful operates, without regard
          ...
          <section className="space-y-3">
            ...
            <p>
              Any disputes arising from these Terms or your use of the App will
              be resolved through binding arbitration in accordance with the
              rules of the relevant arbitration authority, except where
              prohibited by law.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              entire agreement between you and Plateful regarding your use of
